...
class ExtractHouseURL(Request):
    ...
    def getAgency(self):
        agency = self.soup.findAll('a', attrs={'class':'LinkBase-sc-12oy0hl-0 kVCwGI sidebar-traffic-driver__name'})
        num = len(agency)
    ...
    def getFeatures(self):
        ...
        for feature in self.soup.findAll('div', attrs={'class':'View__PropertyDetail-sc-11ysrk6-0 fqvXQG'}):
    ...
    def getLandSize(self):
        land_size  = self.soup.find('div', attrs={'class':'View__PropertySizeGroup-sc-1psmy31-1 dwuCyI property-size-group'})
