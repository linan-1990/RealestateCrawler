...
def export_excel(state): 
    sql_cmd = """ SELECT address, suburb, postcode, house_type, land_size, bedroom, bathroom, parking, sold_price, sold_date, link FROM {}
        WHERE sold_date is not null and sold_price is not null AND YEAR(sold_date) > 2020
